...
THREE.GPUParticleContainer = function(maxParticles, particleSystem) {
  ...
  self.particleShaderGeo.addAttribute(
    "particlePositionsStartTime",
    new THREE.BufferAttribute(self.particlePositionsStartTime, 4).setDynamic(true)
  );
  self.particleShaderGeo.addAttribute(
    "particleVelColSizeLife",
    new THREE.BufferAttribute(self.particleVelColSizeLife, 4).setDynamic(true)
  );
