function MATERIALS() {
  ...
  ROOT.CREATE_CUBE_REFRACTION = function(path_to_images, nameOfThis_materialGroup) {
    ...
    ROOT.urls = [
      ROOT.path_to_images + "px.jpg",
      ROOT.path_to_images + "nx.jpg",
      ROOT.path_to_images + "py.jpg",
      ROOT.path_to_images + "ny.jpg",
      ROOT.path_to_images + "pz.jpg",
      ROOT.path_to_images + "nz.jpg"
    ];
