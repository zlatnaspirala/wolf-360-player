...
function PARTICLE(GUI) {
  ...
  if (GUI == true) {
    ...
    gui_particle.add(ROOT.options, "lifetime", 0.1, 10);
  ...
  ROOT.AUTO_UPDATE = function() {
    ...
    if (delta > 0) {
      ...
      ROOT.options.position.z =
        Math.sin(ROOT.tick * ROOT.spawnerOptions.horizontalSpeed + ROOT.spawnerOptions.verticalSpeed) * 5;
